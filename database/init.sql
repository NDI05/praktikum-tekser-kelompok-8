-- ============================================
-- SIKP OYAKO - Database Initialization Script
-- Sistem Informasi Kasir & Penjualan Warung Oyako
-- ============================================
...
('KRY001', 'Pak Owner Oyako', 'owner@oyako.id', '081234567890', 'OWNER', 1),
('KRY002', 'Kasir Satu', 'kasir1@oyako.id', '081234567891', 'KARYAWAN', 2),
('KRY003', 'Kasir Dua', 'kasir2@oyako.id', '081234567892', 'KARYAWAN', 3);
...
('Mie Goreng Oyako', 'MAKANAN', 22000, 'Mie goreng khas Oyako dengan bumbu rahasia', TRUE),
